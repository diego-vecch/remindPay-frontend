      ...
      <div className='mb-8 flex flex-col gap-2 justify-center w-96'>
        <div className='pt-4 pb-1'>
          ...
          {responseLogin.status === '' && (
            <article className='h-10 flex justify-center' />
          )}
          {responseLogin.status === 'error' && (
            <article className='text-red-600 bg-red-400 bg-opacity-20 text-center h-10 flex items-center justify-center'>
              {responseLogin.message}
            </article>
          )}
          {responseLogin.status === 'success' && (
            <article className='text-green-600 bg-green-400 bg-opacity-20 text-center h-10 flex items-center justify-center'>
              {responseLogin.message}
            </article>
          )}
          {responseLogin.status !== 'success' &&
        ...
        >
          ...
          <div className='w-full flex justify-center'>
            <button
              type='submit'
              className='bg-transparent text-purple-700 rounded-md hover:underline'
            >
