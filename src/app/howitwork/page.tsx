      ...
      <div className='h-full pt-16 flex justify-center items-center '>
        <div className='flex gap-10 w-full px-8 h-[580px] max-w-[1200px] py-2'>
          <section className='w-72 h-80 pt-10'>
            <div className='bg-purple-regular text-yellow-50 w-60 h-60 px-10 rounded-full text-start flex justify-center items-center'>
              <h2 className='text-base font-light pt-2'>
                {' '}
                Remind Pay will help you manage your subscriptions and remind
                you when to renew them.
              </h2>
            </div>
          </section>
          <section className='w-full'>
            <div className='border-[1.3px] border-purple-800 rounded-lg overflow-hidden flex h-full'>
              <div className='relative left-0 bg-purple-half-dark w-[115px] h-full text-yellow-50 flex justify-center flex-col gap-8 text-xs font-extralight py-1 '>
                ...
                <div className='flex flex-col gap-5 px-3 py-4 h-full'>
                ...
                <div className='border-t-[1.5px] border-t-purple-800 px-3 py-4 h-16'>
                  Help & Support
                </div>
              </div>
              <div className='grid grid-cols-3 gap-5 h-full py-6 w-full ml-5'>
                <div className='col-span-2 bg-violet-400 rounded-lg pt-2 pb-4'>
                  ...
                  <footer className='flex justify-center items-center'>
                    <h4 className='px-6 text-purple-800 font-medium text-xs'>
                      Show All
                    </h4>
                  </footer>
                </div>
                ...
                <div className='col-span-2 row-span-1 bg-violet-400 h-full rounded-lg  pt-2 pb-4'>
                  <header className='px-6 pt-4 text-purple-dark font-semibold text-base'>
